// Report Page JavaScript - Real data from API
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    // Verify user has permission to view reports (Admin and Manager only)
...
/**
 * Generate report by fetching real data from the API
 */
    ...
    try {
        switch (reportType) {
            ...
            case 'guest':
                ...
                break;
            case 'payment':
                await fetchRevenueReport(startDate, endDate); // payment uses same financial data
                break;
            default:
...
/**
 * Fetch reservation summary report
 */
async function fetchReservationReport(startDate, endDate) {
    ...
    // Update cancellation card label temporarily
...
async function fetchOccupancyReport() {
    ...
    // Also fetch current room availability for live occupancy
...
/**
 * Fetch guest statistics report
 */
async function fetchGuestReport(startDate, endDate) {
    // Fetch both financial summary and reservations for guest details
    ...
    // Parse reservations and filter by date range
    let reservations = [];
    ...
    // Build guest summary — group by guest name
    const guestMap = {};
...
/**
 * Quick report generation with real data
 */
